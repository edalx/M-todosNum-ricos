...
public class Interpolacion extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Ingrese los puntos. Ej:");

        points.setColumns(20);
        points.setRows(5);
        jScrollPane1.setViewportView(points);

        jLabel4.setText("Punto inicial:");
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(numP, javax.swing.GroupLayout.PREFERRED_SIZE, 41, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel4, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(inic, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        double inicPoint=0;
        double evalPol=0;
        nPoints = Integer.parseInt(numP.getText());
        inicPoint=Double.parseDouble(inic.getText());
        double[] compX = new double[nPoints];
        double[] compY = new double[nPoints];
        double[] coefLag=new double[nPoints];
        String[] coefmat=new String[nPoints];
        coefmat=points.getText().split("\n");
        for (int i = 0; i < nPoints; i++) {
     
            coordenadas = coefmat[i].split(",");
