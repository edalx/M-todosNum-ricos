...
public class ControlerIntegracion {
    ...
    public void main() {
        ...
        int partition = 0;
        int option = 0;
        System.out.println("Ingrese la función que desea integrar:");
        function = leer.nextLine();
        while (true) {
            System.out.println("Ingrese los límites de la integral");
        ...
        System.out.println("");
        System.out.println("Elija un método de integración numérica: ");
        ...
        switch (option) {
            case 1:
                while (true) {
                    System.out.println("Ingrese el número de particiones: ");
                    partition = Integer.parseInt(leer.nextLine());
                    if (partition > 0) {
                        break;
                    }
                    System.out.println("El número de particiones tiene que ser positivo");
                }
                resultTrapecio = operation.trapecio(function, a, b, partition);
                System.out.println("");
                System.out.println("***********************************************************************");
                System.out.println("Regla de Trapecios: ∫" + function + "dx ≈ " + resultTrapecio);
                System.out.println("***********************************************************************");
                break;
            ...
            case 2:
                while (true) {
                    ...
                    System.out.println("El número de particiones tiene que ser par y positivo");
                }

                resultSimpson = operation.simpson1_3(function, a, b, partition);
                System.out.println("");
                System.out.println("***********************************************************************");
                System.out.println("Simpson 1/3 : ∫" + function + "dx ≈ " + resultSimpson);
                System.out.println("***********************************************************************");
                break;
            default:
